...
object FunSets {
  ...
  /**
    ...
    */
  // удовлетворяет условиям: входит в множество s и одновременно соответствует предикату p
  ...
  def exists(s: Set, p: Int => Boolean): Boolean = {
    //    def iter(a: Int): Boolean = {
    //      if (a > bound) false
    //      // множество содержит элемент а, который одновременно удовлетворяет условиям принадлежности к множеству s
    //      // и соответствия предикату p (intersect(s, p))
